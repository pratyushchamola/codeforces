...
void solve() {
  ...
  while (t--)
  {
   ...
   // suffix array to calculate the minimum number of swaps required from a given i to n;
   for(ll i=n-1;i>=0;i--){
       minswap = min(minswap,values[i].second);
       values[i].second = minswap;
   }
