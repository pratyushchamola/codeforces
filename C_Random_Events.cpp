...
//    cout << k << endl;
   ...
   ll lastsortedind = n-1;

   while((lastsortedind >= 0) && (values[lastsortedind] == (lastsortedind+1)))lastsortedind--;

   double ans = 1;

   if(lastsortedind == -1)ans = 0;
   ...
   while(k>0){
       ...
       if(curind >= lastsortedind)ans = ans*(1-pro);

       k--;
   }

//    cout << lastsortedind << endl;
