...
void solve() {
  ...
  while (t--)
  {
   ...
   while(l > 0){
       if(cnt%2==1){
           values[l] = minele+1;
           answer.push_back({minind,l,minele,minele+1});
       }else{
           values[l] = minele;
           answer.push_back({minind,l,minele,minele});
       }
   ...
   while(r <= n){
       if(cnt%2==1){
           values[r] = minele+1;
           answer.push_back({minind,r,minele,minele+1});
       }else{
           values[r] = minele;
           answer.push_back({minind,r,minele,minele});
       }
...
//    for(ll i=2;i<=n;i++)cout << gcd(values[i],values[i-1]) << " ";
//    cout << endl;
